OpenJabNab : An open PHP/C++-based proxy framework for the Nabaztag/Tag™ (http://www.nabaztag.com/) electronic pet with jabber protocol.
...
III) Requirements
	...
	- A Nabaztag/tag with the jabber beta activated
